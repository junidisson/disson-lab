  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (res.ok) {
        ...
        alert('Something went wrong. Please try Telegram or WhatsApp instead.');
      }
    } catch {
      alert('Something went wrong. Please try Telegram or WhatsApp instead.');
    } finally {
      ...
      <div className="max-w-5xl mx-auto">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-lg text-forest/70 max-w-xl mx-auto leading-relaxed">
            Share your goal, your idea, or just a thought — we'll take it from here.
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-2 gap-16">
          ...
          <div>
            ...
            <div className="space-y-6">
              ...
              <a 
                href="https://wa.me/6282340238286" 
                target="_blank"
                rel="noopener noreferrer"
                className="flex items-center gap-4 text-forest hover:text-sage transition-colors"
              >
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <button
              type="submit"
              disabled={sending}
              className="w-full px-8 py-4 bg-forest text-cream rounded-full font-medium transition-all hover:bg-forest/90 disabled:opacity-60"
            >
